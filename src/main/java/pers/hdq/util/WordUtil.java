    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 1; i < 800; i++) {
            ...
            r.setText("过去一年是党和国家历史上具有里程碑意义的一年。以习近平同志为核心的党中央团结带领全党全国各族人民，隆重庆祝中国共产党成立一百周年，胜利召开党的十九届六中全会、制定党的第三个历史决议，如期打赢脱贫攻坚战，如期全面建成小康社会、实现第一个百年奋斗目标，开启全面建设社会主义现代化国家、向第二个百年奋斗目标进军新征程。一年来，面对复杂严峻的国内外形势和诸多风险挑战，全国上下共同努力，统筹疫情防控和经济社会发展，全年主要目标任务较好完成，“十四五”实现良好开局，我国发展又取得新的重大成就。\n" +
                    ...
                    "\n" +
                    "要坚持政府过紧日子，更好节用裕民。大力优化支出结构，保障重点支出，严控一般性支出。盘活财政存量资金和闲置资产。各级政府必须艰苦奋斗、勤俭节约，中央政府和省级政府要带头。加强收支管理，严禁铺张浪费，不得违规新建楼堂馆所，不得搞形象工程，对违反财经纪律、肆意挥霍公款的要严相似度比对处，一定要把宝贵资金用在发展紧要处、民生急需上。\n" +
                    "\n" +
            ...
            out = new FileOutputStream("F:\\桌面\\相似度比对大文本\\文档" + i + ".docx");
            doc.write(out);
        }
        out.close();
    }
